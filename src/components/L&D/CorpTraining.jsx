  ...
  return (
    <Box sx={{ width: "100%", my: 10 }}>
      <Box sx={{ px: 6 }}>
        ...
        >
          CORPORATE TRAINING <SouthEastIcon />
        </Typography>
      </Box>
...
//     <Box sx={{ width: "100%", my: 10 }}>
//       <Box sx={{ px: 6 }}>
//         <Typography variant="h6" sx={{display:"flex", alignItems:"center", justifyContent:"start"}}>CORPORATE TRAINING <SouthEastIcon/></Typography>
//       </Box>
